...
| T-191 Add adaptive Notes live cadence | Completed | P1/P2, Notes responsiveness. Added normal/showcase cadence profiles with a faster content-gated first transcription and live update path for demos, one-in-flight scheduling, clean timer lifecycle, and unchanged model/prompt/finalisation/recovery contracts. |
